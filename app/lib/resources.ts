...
export const resourceArticles: ResourceArticle[] = [
  ...
  },
  {
    ...
    description: "Understand when broad Instagram reach supports a business, when it becomes vanity attention, and how audience, offer, profile, and measurement change the answer.",
